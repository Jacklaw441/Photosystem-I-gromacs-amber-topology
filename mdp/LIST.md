...
| minim.mdp | Energy minimisation | Steepest descent minimisation until maximum force converges below 1000 kJ mol⁻¹ nm⁻¹. Run on the solvated, ionised system before equilibration. |
